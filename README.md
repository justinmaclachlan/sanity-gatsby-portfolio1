...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/7ft0s95t/settings/api) and create a token with read rights.
